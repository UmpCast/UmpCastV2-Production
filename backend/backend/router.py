...
from schedules.api.viewsets import TimeRangeViewSet, AssignmentItemViewSet, AssignmentViewSet, SpecialBlockViewSet
...
router.register('schedule-specialblocks', SpecialBlockViewSet,
                basename='schedule-specialblock')
